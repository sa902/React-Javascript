	...
	return (
		<div style={{display: 'flex', justifyContent:'center'}}>
			...
			<div style={{ width: 325, height: 425, position: 'relative', flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'center', display: 'inline-flex' }}>
				...
				<div style={{ color: 'black', fontSize: 30, fontFamily: 'Inter', margin:15,padding:15, fontWeight: '400', wordWrap: 'break-word', paddingBottom: '0.5em', fontFamily:"Glass Antiqua" }}>{title}</div>
